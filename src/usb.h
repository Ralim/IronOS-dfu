...
#define USB_EP_NTOGGLE_MSK                                                     \
  (USB_EP_RX_CTR | USB_EP_SETUP | USB_EP_TYPE | USB_EP_KIND | USB_EP_TX_CTR |  \
   USB_EP_ADDR)
...
#define USB_SET_EP_TYPE(EP, TYPE)                                              \
  SET_REG(USB_EP_REG(EP),                                                      \
          (GET_REG(USB_EP_REG(EP)) & (USB_EP_NTOGGLE_MSK & (~USB_EP_TYPE))) |  \
              TYPE)

#define USB_SET_EP_ADDR(EP, ADDR)                                              \
  SET_REG(USB_EP_REG(EP),                                                      \
          ((GET_REG(USB_EP_REG(EP)) & (USB_EP_NTOGGLE_MSK & (~USB_EP_ADDR))) | \
           ADDR))
...
#define USB_SET_EP_RX_STAT(EP, STAT)                                           \
  TOG_SET_REG_BIT_MSK_AND_SET(USB_EP_REG(EP), USB_EP_RX_STAT_TOG_MSK, STAT,    \
                              USB_EP_RX_CTR | USB_EP_TX_CTR)

#define USB_SET_EP_TX_STAT(EP, STAT)                                           \
  TOG_SET_REG_BIT_MSK_AND_SET(USB_EP_REG(EP), USB_EP_TX_STAT_TOG_MSK, STAT,    \
                              USB_EP_RX_CTR | USB_EP_TX_CTR)

/* Macros for clearing DTOG bits */
#define USB_CLR_EP_TX_DTOG(EP)                                                 \
  SET_REG(USB_EP_REG(EP),                                                      \
          GET_REG(USB_EP_REG(EP)) & (USB_EP_NTOGGLE_MSK | USB_EP_TX_DTOG))

#define USB_CLR_EP_RX_DTOG(EP)                                                 \
  SET_REG(USB_EP_REG(EP),                                                      \
          GET_REG(USB_EP_REG(EP)) & (USB_EP_NTOGGLE_MSK | USB_EP_RX_DTOG))
...
#define USB_CLR_EP_NTOGGLE_BIT_AND_SET(EP, BIT, EXTRA_BITS)                    \
  CLR_REG_BIT_MSK_AND_SET(USB_EP_REG(EP), USB_EP_NTOGGLE_MSK, BIT, EXTRA_BITS)
